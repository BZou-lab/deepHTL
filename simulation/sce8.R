...
df_sce8 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce8/res%d.Rdata", batch_id)
save(df_sce8, file = output_file)