...
df_sce10 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce10/res_dnn%d.Rdata", batch_id)
save(df_sce10, file = output_file)