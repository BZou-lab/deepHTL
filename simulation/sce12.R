...
set.seed(n + p + sigma + 12 * batch_id)
...
df_sce12 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce12/res%d.Rdata", batch_id)
save(df_sce12, file = output_file)