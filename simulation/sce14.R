...
set.seed(n + p + sigma + 14 * batch_id)
...
df_sce14 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce14/res%d.Rdata", batch_id)
save(df_sce14, file = output_file)