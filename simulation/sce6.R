...
df_sce6 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce6/res%d.Rdata", batch_id)
save(df_sce6, file = output_file)