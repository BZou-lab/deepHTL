...
df_sce5 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce5/res%d.Rdata", batch_id)
save(df_sce5, file = output_file)