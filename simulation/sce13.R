...
set.seed(n + p + sigma + 13 * batch_id)
...
df_sce13 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce13/res%d.Rdata", batch_id)
save(df_sce13, file = output_file)