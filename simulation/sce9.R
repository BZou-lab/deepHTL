...
df_sce9 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce9/res%d.Rdata", batch_id)
save(df_sce9, file = output_file)