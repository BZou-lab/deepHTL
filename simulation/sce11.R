...
set.seed(n + p + sigma + 11 * batch_id)
...
df_sce11 <- do.call(rbind, lapply(sce, as.data.frame))

output_file <- sprintf("/nas/longleaf/home/shuaiy/project/simulation/sce11/res%d.Rdata", batch_id)
save(df_sce11, file = output_file)